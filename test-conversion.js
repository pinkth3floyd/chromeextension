// Test script to verify corrected Nepali date conversion
class NepaliCalendar {
    constructor() {
        ...
        this.nepaliCalendarData = {
            ...
            2082: [30, 29, 30, 29, 30, 29, 30, 29, 30, 29, 30, 30],
        ...
        // Base date: 1 Baisakh 2080 BS = 14 April 2023 AD
        this.baseDate = new Date(2023, 3, 14); // April 14, 2023
...
console.log('=== Corrected Nepali Calendar Date Conversion Test ===');
...
console.log('\n=== Known Date Tests ===');
const testDate1 = new Date(2023, 3, 14); // April 14, 2023
const nepaliDate1 = calendar.gregorianToNepali(testDate1);
console.log('April 14, 2023 =', calendar.formatNepaliDate(nepaliDate1), '(should be 1 Baisakh 2080)');
